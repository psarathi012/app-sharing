...
export default class Recived extends Component {
  constructor(props) {
    super(props);
    this.state = {
      receivedInterests: [],
      ...
      images: [],
      iscolor1: false,
      sentInterests: [], button1: false, button2: true,
    };
  }
  ...
  async getProfile() {
    fetch(URL + 'profile', {
      ...
      .then(responseJson => {
        ...
        console.log('receivedInterestslllllllllllllllllllllllllllllllll', receivedInterests)
      })
      .catch(error => {
  ...
  async acceptedme() {
    fetch(URL + 'profile', {
      ...
      .then(responseJson => {
        ...
        sentInterests = sentInterests.filter(a => a.status === "accepted");
        ...
        <ScrollView>
          <View style={{ flex: 1, flexDirection: 'row', position: 'relative' }}>
            ...
            <View style={{ flex: 0.5, marginLeft: '-50%' }}>
              <Text style={[styles.heading, { paddingLeft: 15 }]}>Accepted</Text>
            </View>
          </View>
          {/* ///////////////////////////////////////////////////////////////////// */}
