...
import { View, Text, TouchableOpacity,  StatusBar, Image, ScrollView,AsyncStorage } from 'react-native';
...
export default class Groom extends Component {
  ...
  state = {
    ...
    selectedItem1: '40', selected_state:[], state:[], selected_city:[], city:[],
    minheight: [],
        ...
        <View>
          <Text style={[styles.title, { marginTop: 0 }]}>Height</Text>
            ...
            <View style={{ flexDirection: 'row' }}>
              <View style={{ width: '48%' }}>
                <Text style={styles.subtitle}>Min Height</Text>
              ...
              <View style={{ width: '48%', marginLeft: '2%' }}>
                <Text style={styles.subtitle}>Max Height</Text>
                <View style={styles.pickersty}>
                  <RNPickerSelect
                    placeholder={{
                      label: 'Choose',
